...
class PokemonRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function feedPokemons(array $pokemons)
    {
    ...
    public function feedPokemon(int $id, int $newHunger)
    {
        $qb = $this->_em->createQueryBuilder();
    ...
    public function getOrderedPokemonsFromWaiting(int $userId)
    {
        return $this->createQueryBuilder('p')
            ->where('p.owner = :owner')
            ->andWhere('p.exchange = 0')
    ...
    public function getOrderedPokemonsFromMarket(int $userId)
    {
        return $this->createQueryBuilder('p')
            ->where('p.owner = :owner')
            ->andWhere('p.exchange = 0')
    ...
    public function movePokemonsToReserve(array $pokemons)
    {
        $qb = $this->_em->createQueryBuilder();
        $qb->update('AppBundle:Pokemon', 'p')
            ->set('p.block', 1)
    ...
    public function movePokemonsToWaiting(array $pokemons)
    {
        $qb = $this->_em->createQueryBuilder();
        $qb->update('AppBundle:Pokemon', 'p')
            ->set('p.block', 0)
    ...
    public function addExpByTraining(int $exp, int $userId)
    {
        $qb = $this->_em->createQueryBuilder();
        $qb->update('AppBundle:Pokemon', 'p')
            ->set('p.exp', 'p.exp + :exp')
    ...
    public function addAtachmentToPokemonsInTeam(int $userId, int $quantity)
    {
        $qb = $this->_em->createQueryBuilder();
        $qb->update('AppBundle:Pokemon', 'p')
    ...
    public function pokemonsThatCanBeSoldOnMarket(int $userId)
    {
        $qb = $this->_em->createQueryBuilder();
        $qb->select('pokemon')
    ...
    public function addExpToPokemons(array $pokemons, int $exp)
    {
